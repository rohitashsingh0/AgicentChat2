    ...
    <main className="relative flex flex-col h-screen p-1 overflow-hidden dark:bg-light-grey">
      ...
      <section className="flex flex-col flex-grow w-full px-4 overflow-y-scroll sm:px-10 md:px-32">
        {messages.length ? (
          ...
          <div className="flex my-2" style={{ margin: "20vh 0" }}>
      ...
      <form
        className="flex flex-col px-10 mb-2 md:px-32 join sm:flex-row mb-5"
      ...
      >
        ...
        <div className="flex items-stretch justify-between w-full">
          <textarea
            ref={inputRef}
            className="w-full grow input input-bordered join-item max-h-[20rem] pt-3 min-h-[3rem]"
            value={formValue}
